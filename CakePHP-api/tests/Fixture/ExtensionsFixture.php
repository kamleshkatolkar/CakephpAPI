...
class ExtensionsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'extension_no' => ['type' => 'integer', 'length' => 4, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-07 16:01:11',
                'modified' => '2018-07-07 16:01:11'
            ],
        ];
        parent::init();
    }
